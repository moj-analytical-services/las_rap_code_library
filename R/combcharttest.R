...
#   scale_color_manual(values = c("#2C486E","#789AC8", "#DDE5F1"),
#                      guide=guide_legend(nrow=3, byrow= T, title = "")) + # Set line colours
...
# for (i in yearbreaks) {
#   cgraphtestval <- cgraphtestval + geom_segment(x=i, xend=i, y=vyearlocation, yend=0, colour="lightgrey", show.legend = FALSE)
# }
# 
# 
# # Allow for annotation outside of plot area (prevent Qs from cutting off) and plot chart
# fig2 <- ggplot_gtable(ggplot_build(cgraphtestval))
...
# # Plot lines for year seperators
# for (i in yearbreaks) {
#   cgraphtestvol <- cgraphtestvol + geom_segment(x=i, xend=i, y=vyearlocation, yend=0, colour="lightgrey", show.legend = FALSE)
# }
# 
# 
# # Allow for annotation outside of plot area (prevent Qs from cutting off) and plot chart
# fig1 <- ggplot_gtable(ggplot_build(cgraphtestvol))
